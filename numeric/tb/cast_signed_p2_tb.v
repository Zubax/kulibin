// iverilog -Wall -Wno-timescale -y. cast_signed_p2_tb.v && vvp a.out
...
module cast_signed_p2_tb;
    ...
    cast_signed_p2 #(.WIN(8), .MSB(2), .LSB(2)) dut(
        .clk(clk),
        .rst(rst),
        .in_valid(in_valid),
        .in_data(din),
    ...
    cast_signed_p2 #(.WIN(8), .MSB(-2), .LSB(-2)) dut_widening(
        .clk(clk),
        .rst(rst),
        .in_valid(in_valid),
        .in_data(din),
    ...
    initial begin
        $dumpfile("cast_signed_p2_tb.vcd");
        $dumpvars();
    end
endmodule
