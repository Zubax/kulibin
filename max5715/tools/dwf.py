...
class AnalogDiscovery:
    ...
    def arm_logic_capture(self, rate: float = 100e6, samples: int = 4096,
        ...
        _check(_dwf.FDwfDigitalInBufferSizeSet(h, ctypes.c_int(samples)), "DigitalInBufferSizeSet")
        ...
        if fall_mask or rise_mask:
            ...
            _check(_dwf.FDwfDigitalInTriggerSet(h, ctypes.c_uint(0), ctypes.c_uint(0),
                   ...
                   "DigitalInTriggerSet")
            _check(_dwf.FDwfDigitalInTriggerPositionSet(h, ctypes.c_uint(samples - prefill)),
