...
/// Table+polynomial core for zkf_exp2 at WMAN=7 (degree 2); zero-bubble, see _zkf_horner.
...
module _zkf_exp2_m7_d2 #(parameter integer WMAN = 7, parameter integer SBW = 1, parameter integer STAGE_PRODUCT = 0) (
    input  wire                   clk,
    input  wire                   rst,
    input  wire                   in_valid,
    ...
    initial begin
        rom[0] = {22'h00218c, 22'h0161d4, 22'h08000f};
        rom[1] = {22'h0027e5, 22'h01a4c6, 22'h098391};
        rom[2] = {22'h002f72, 22'h01f463, 22'h0b5065};
        rom[3] = {22'h00386c, 22'h025310, 22'h0d7469};
    end
