...
/// Table+polynomial core for zkf_log2 at WMAN=7 (degree 2); zero-bubble, see _zkf_horner.
...
module _zkf_log2_m7_d2 #(parameter integer WMAN = 7, parameter integer SBW = 1, parameter integer STAGE_PRODUCT = 0) (
    input  wire                   clk,
    input  wire                   rst,
    input  wire                   in_valid,
    ...
    initial begin
        rom[0] = {22'h000d72, 22'h3f480b, 22'h0b8a9a};
        rom[1] = {22'h000a73, 22'h3f62c9, 22'h0ae006};
        rom[2] = {22'h000852, 22'h3f7798, 22'h0a4d37};
        rom[3] = {22'h0006c2, 22'h3f882b, 22'h09cd18};
        rom[4] = {22'h000594, 22'h3f95a3, 22'h095bff};
        rom[5] = {22'h0004ac, 22'h3fa0c3, 22'h08f731};
        rom[6] = {22'h0003f5, 22'h3faa15, 22'h089c9c};
        rom[7] = {22'h000364, 22'h3fb1fb, 22'h084aa3};
    end
