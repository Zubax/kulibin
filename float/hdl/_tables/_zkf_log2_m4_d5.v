...
/// Table+polynomial core for zkf_log2 at WMAN=4 (degree 5); zero-bubble, see _zkf_horner.
...
module _zkf_log2_m4_d5 #(parameter integer WMAN = 4, parameter integer SBW = 1, parameter integer STAGE_PRODUCT = 0) (
    input  wire                   clk,
    input  wire                   rst,
    input  wire                   in_valid,
    ...
    initial begin
        rom[0] = {19'h7ff5d, 19'h0037e, 19'h7f4f9, 19'h01eaa, 19'h7a3ad, 19'h17154};
        rom[1] = {19'h7ffe4, 19'h000b9, 19'h7fcef, 19'h00c3b, 19'h7cab8, 19'h12b80};
    end
