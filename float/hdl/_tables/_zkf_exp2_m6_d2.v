...
/// Table+polynomial core for zkf_exp2 at WMAN=6 (degree 2); zero-bubble, see _zkf_horner.
...
module _zkf_exp2_m6_d2 #(parameter integer WMAN = 6, parameter integer SBW = 1, parameter integer STAGE_PRODUCT = 0) (
    input  wire                   clk,
    input  wire                   rst,
    input  wire                   in_valid,
    ...
    localparam integer CF   = 18;
    localparam integer RW   = 16;
    localparam integer CW   = 21;
    localparam integer ACCW = 23;
    ...
    initial begin
        rom[0] = {21'h0010c6, 21'h00b0ea, 21'h040008};
        rom[1] = {21'h0013f3, 21'h00d263, 21'h04c1c9};
        rom[2] = {21'h0017b9, 21'h00fa32, 21'h05a832};
        rom[3] = {21'h001c36, 21'h012988, 21'h06ba35};
    end
