...
/// Table+polynomial core for zkf_log2 at WMAN=6 (degree 3); zero-bubble, see _zkf_horner.
...
module _zkf_log2_m6_d3 #(parameter integer WMAN = 6, parameter integer SBW = 1, parameter integer STAGE_PRODUCT = 0) (
    input  wire                   clk,
    input  wire                   rst,
    input  wire                   in_valid,
    ...
    initial begin
        rom[0] = {21'h1fe8d4, 21'h006eed, 21'h1e90f3, 21'h05c540};
        rom[1] = {21'h1ff853, 21'h002e49, 21'h1f2b64, 21'h04adfd};
    end
