...
A small and FPGA-friendly floating point format that is similar to IEEE 754 but intentionally omits support for NaN, infinity, subnormals, exceptions, and rounding modes other than round-to-nearest, ties-to-even. Numbers underflow to zero instead of subnormals. Overflow is saturated to maximum instead of infinity. Only one canonical positive zero representation exists.
